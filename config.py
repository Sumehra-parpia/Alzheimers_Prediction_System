...
IMPUTED_CATEGORIES = [
    'imputed_genotype_True',
    'imputed_genotype_False'
]
...
CONDITION_DESCRIPTION = {
    ...
    "LMCI": "This suggests that the individual is in a stage of mild cognitive impairment that is progressing towards Alzheimer's disease. Mild Cognitive Impairment is a transitional state between normal cognitive aging and more significant cognitive decline.",
...
# =========================
# NEWS PAGE (NO SECRETS NEEDED NOW)
# =========================
NEWS_API_KEY = ""
KEYWORD = "alzheimer"

# =========================
# CHATBOT PAGE (NO SECRETS NEEDED NOW)
# =========================
HF_EMAIL = ""
HF_PASS = ""
BASE_PROMPT = "You are a helpful Alzheimer assistant that gives simple and clear explanations."
